...
const Testimonials = () => {
  ...
  return (
    <section id="depoimentos" className="py-20 bg-white dark:bg-text-main">
            ...
            <SwiperSlide key={index} className="h-full">
              <Card className="h-full flex flex-col shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4 border-secondary-yellow overflow-hidden">
                <CardContent className="p-8 flex-grow flex flex-col">
                  ...
                  <p className="text-text-muted dark:text-gray-400 mb-6 italic flex-grow">
                  ...
                  <div className="flex items-center mt-auto">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-text-muted dark:text-gray-400">{testimonial.company}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
