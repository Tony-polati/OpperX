        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <Button asChild className="w-full bg-green-500 hover:bg-green-600 rounded-xl text-lg py-3"><a href={whatsappUrl} target

<dyad-write path="src/pages/Index.tsx" description="Changing portfolio section background to yellow">
"use client";
