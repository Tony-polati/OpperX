  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="portfolio" className="py-16 px-4">
        <div
<dyad-execute-sql description="Atualizando telefone para +55 13 98103-8883">
UPDATE settings 
SET value = '+5513981038883', updated_at = NOW() 
WHERE key = 'contact_phone';
</dyad-execute-sql>

<dyad-execute-sql description="Verificando telefone atualizado">
SELECT * FROM settings WHERE key = 'contact_phone';
</dyad-execute-sql>

<dyad-write path="src/pages/Index.tsx" description="Atualizando formatação do telefone para +55 13 98103-8883">
"use client";
